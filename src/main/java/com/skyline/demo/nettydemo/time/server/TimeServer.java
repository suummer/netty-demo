package com.skyline.demo.nettydemo.time.server;

import com.skyline.demo.nettydemo.time.server.handler.TimeChannelInitializer;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
                    ...
                    // 新创建的 Channel将由指定的处理器处理
                    .childHandler(new TimeChannelInitializer())
                    // 设置 Channel的参数
